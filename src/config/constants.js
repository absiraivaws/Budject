...
export const SRI_LANKAN_BANKS = [
  ...
  { id: 'alliance_finance', name: 'Alliance Finance Company PLC', icon: '🏦' },
  ...
  { id: 'hdfc_bank', name: 'HDFC Bank of Sri Lanka', icon: '🏦' },
  ...
  { id: 'mcb_bank', name: 'MCB Bank Ltd', icon: '🏦' },
  { id: 'mercantile_investments', name: 'Mercantile Investments and Finance PLC', icon: '🏦' },
  ...
  { id: 'national_savings', name: 'National Savings Bank', icon: '🏦' },
  { id: 'nations_trust', name: 'Nations Trust Bank PLC', icon: '🏦' },
  { id: 'pan_asia', name: 'Pan Asia Banking Corporation PLC', icon: '🏦' },
  { id: 'pradeshiya_sanwardhana', name: 'Pradeshiya Sanwardhana Bank', icon: '🏦' },
  { id: 'sampath_bank', name: 'Sampath Bank PLC', icon: '🏦' },
  { id: 'sanasa_development', name: 'Sanasa Development Bank PLC', icon: '🏦' },
  ...
  { id: 'sri_lanka_savings', name: 'Sri Lanka Savings Bank Ltd', icon: '🏦' },
